  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 p-2 rounded-lg bg-white shadow-md border border-gray-200 text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-[#605DEC]"
      ...
      >
        <div className="flex-1 overflow-y-auto flex flex-col justify-between">
          ...
          <div className="p-6 border-t border-gray-100">
            <Link
              href="/"
              className="flex items-center gap-2.5 text-xs font-medium text-gray-500 hover:text-gray-800 transition-colors p-2 rounded-md hover:bg-gray-50"
            >
